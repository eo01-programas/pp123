(() => {
    ...
    function getElements() {
        return {
            ...
            supervisorSelect: document.getElementById('preparado-mobile-supervisor'),
    ...
    function buildPassesHtml(record) {
        ...
        const supervisores = parsePassValues(record.preparado_supervisor);
        ...
        const lines = inicios.map((inicio, i) => {
            ...
            const metaParts = [
                ...
                supervisores[i] ? TintoreriaUtils.escapeHtml(supervisores[i]) : '',
    ...
    async function handleInicio() {
        ...
        if (!supervisor) {
            showToast('Selecciona un supervisor antes de registrar el inicio.');
            ...
            .map((recordId) => {
                ...
                return {
                    ...
                    changes: {
                        ...
                        preparado_supervisor: appendPassValue(record.preparado_supervisor, supervisor),
        ...
        try {
            ...
            els.inicioBtn.disabled = false;
            els.inicioBtn.textContent = 'INICIO';
        }
    }
    ...
    async function handleFin() {
        ...
        try {
            ...
            els.finBtn.disabled = false;
            els.finBtn.textContent = 'FIN';
        }
    }
